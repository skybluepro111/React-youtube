...
function saveRecording(blob) {
  ...
  var html = "<div class='audioBox' recording='" + url + "'>" +
    ...
    " <ul id='audioButtons'><li><a class='icon-flatline-download-alt pret-btn blue btn-outlined btn btn-default' id='download' title='descargar' href='" + url +
        "' download='recording.wav'>" +
    "</a></li> " +
    "<li><button class='icon-stroke-gap-icons-Delete pret-btn red btn-outlined btn btn-default' title='eliminar' id='remove' recording='" +
            url + "'></button></li>" +
    "<li><button class='icon-ikons-circle-right pret-btn green btn-outlined btn btn-default' title='continuar' id='continue' recording='" +
            url + "'></button></li>" +
    "</ul></div>";
...
// recording process
var worker = new Worker('/js/audio/EncoderWorker.js');
